    ...
    const profile = (
      <Menu className="profile-container">
        <Menu.Item style={{backgroundColor:"rgb(237 237 255)"}}>
         ...
         <p  > <span className="myaccount">My Account</span><span className="signout">Sign Out</span></p>
         </div>
        </Menu.Item>
        ...
        <ul className="organization">
          ...
          <li className="manage"><SettingOutlined /> Manage</li>
...
<Space className="search-container"  direction="vertical">
    <Input className="search"
      placeholder="Search in customers"
      prefix={prefix}
      // iconRender={visible => ( <SearchOutlined  style={{float:"left"}}/>)}
    />
  </Space>
</li>
